...
## API technology
When the user makes a picture of a plant, it gets sent to [Plant.id API](https://plant.id/) that responds with suggestions of plants.
<img alt="screenshot"  src="https://plant.id/assets/logo.large.png" width="35" >
