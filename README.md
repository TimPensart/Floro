# <img style="border-radius: 10" alt="screenshot" src="https://github.com/TimPensart/Floro/blob/master/app/src/main/ic_launcher-playstore.png" height="30" > Floro android app
